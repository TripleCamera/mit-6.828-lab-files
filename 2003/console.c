...
static u_char esc1map[256] = 
{
	...
	NO,   NO,   NO,   NO,   NO,   '/',  NO,   NO,
	NO,   NO,   NO,   NO,   NO,   NO,   NO,   NO,
	NO,   NO,   NO,   NO,   NO,   NO,   BREAK,  HOME,
	UP, PAGEUP, NO,   LEFT, NO,  RIGHT, NO,   END,
	DOWN,PAGEDOWN,INS,DEL,  NO,   NO,   NO,   NO,
};

static u_char shiftmap[256] = 
{
	NO,   033,  '!',  '@',  '#',  '$',  '%',  '^',
	'&',  '*',  '(',  ')',  '_',  '+',  '\b', '\t',
	'Q',  'W',  'E',  'R',  'T',  'Y',  'U',  'I',
